...
public class DataController {
    ...
    public String registDataPOST(@Valid DataDTO dataDTO,
        ...
        int resultFile = dataServiceIf.data_fileUpload(dataDTO.getMember_id(), comu_file, dataDTO.getComu_title(), dataDTO.getComu_content());

        if (file.isEmpty() || file == null) {
            FileUtil.dataDeleteFile(comu_file);
        }

  /*      int result = dataServiceIf.registData(dataDTO);*/
