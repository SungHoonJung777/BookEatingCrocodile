...
public class AdminOneController {
    ...
    public String registQnaPOST(@Valid QnaDTO qnaDTO,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/admin/one/write";
        }

        int result = qnaServiceIf.registQna(qnaDTO);
        if (result > 0) {

            return "redirect:/admin/oneList";
        }
    ...
    public String viewPOST(@Valid QnaDTO qnaDTO,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/admin/one/modify?qna_idx=" + qnaDTO.getQna_idx();
        }

        int result = qnaServiceIf.modifyQna(qnaDTO);

        if (result > 0) {
            return "redirect:/admin/one/view?qna_idx=" + qnaDTO.getQna_idx();
        }
        else {
            return "redirect:/admin/one/modify";
        }
...
//        }
        ...
        if (result > 0) {
            return "redirect:/admin/one/view?qna_idx=" + qnaAdminDTO.getQna_idx();
        }
    ...
    public String deleteAdminGET(int qna_idx) {
        ...
        return "redirect:/admin/one/view?qna_idx=" + qna_idx;
    }
}
