...
/*    @Override
    ...
    @Override
    public int modifyData(String comu_title, String comu_content, String comu_file, int comu_idx) {
        int result = dataMapper.modifyData(comu_title, comu_content, comu_file, comu_idx);
        return result;
    }
