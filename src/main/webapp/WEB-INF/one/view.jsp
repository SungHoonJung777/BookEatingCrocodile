                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="submit" class="btn btn-primary" onclick="location.href='/one/modify?qna_idx=${qnaDTO.qna_idx}'">수정하기</button>
...
<script>
    ...
    document.getElementById("adminDelete").addEventListener("click", () => {
        ...
        if (yn) {
            location.href="/one/adminDelete?qna_idx=${qnaDTO.qna_idx}";
        }
