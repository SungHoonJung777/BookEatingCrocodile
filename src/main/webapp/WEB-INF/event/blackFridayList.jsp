                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach var="list" items="${list}">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge bg-label-primary me-1">${list.pro_price}원</span></td>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${list.black_status eq 'n'}">
                                                    <div class="col-sm-10">
                                                        <button class="findBtn" type="button"  >경매 시작</button>
                                                    </div>
                                                </c:when>
                                                <c:when test="${list.black_status eq 's'}">
                                                    <div class="col-sm-10">
                                                        <button class="findBtn" type="button">경매 중</button>
                                                    </div>
                                                </c:when>
                                                <c:when test="${list.black_status eq 'e'}">
                                                    <div class="col-sm-10">
                                                        <button class="findBtn" type="button" >경매 종료</button>
                                                    </div>
                                                </c:when>
                                            </c:choose>
...
<script>
    document.querySelector(".findBtn").addEventListener("click" , function () {
        let time = document.querySelector('#timeSelect').value;
        location.href = '/event/timerStart?time='+time;
    });
</script>
<!-- / Layout wrapper -->
