            ...
            <!-- / Navbar -->
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">블랙프라이데이/</span> 경매 상품 등록</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="mb-0">경매 상품 등록</h5>
                                        <small class="text-muted float-end">*표시는 필수입력사항</small>
                                    </div>
                                    <div class="card-body">
                                        <div class="col-sm-10">
                                            <button id="findBtn" type="button" class="btn btn-primary" onclick="openPopup()">상품 찾기</button>
                                        </div>
                                        <form name="frm" id="form" >
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="pro_name" id="pro_name" placeholder="" value="${productDetail.pro_name}" readonly/>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input
                                                            ...
                                                            placeholder=""
                                                            name="pro_company"
                                                            value="${productDetail.pro_company}" readonly
                                                    />
                                                </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <input
                                                                ...
                                                                name="pro_writer"
                                                                value="${productDetail.pro_writer}" readonly
                                                        />
                            ...
                            <textarea
                                    ...
                                    value=""
                                    rows="30"
                                    aria-describedby="basic-icon-default-message2" readonly
                            >${productDetail.pro_content}</textarea>--%>
                              ...
                              ></span>
                                                                    <input
                                                                            ...
                                                                            name="pro_price"
                                                                            value="${productDetail.pro_price}" readonly
                                                                    />
                                                                </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            <label class="col-sm-2 col-form-label" for="pro_name">* 경매 시작가</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" name="black_price" id="black_price" placeholder="" value="" />
                                                            </div>
                                                            <span id="final_blackPriceChk" style="display: none; color: red;">공백 없이 입력해주세요.</span>
                                                        </div>
...
<script>
    function openPopup() {
        ...
        let popupUrl = "/event/productList" ; // 팝업 창에 표시할 내용에 대한 URL을 여기에 설정합니다.
    ...
    document.querySelector("#modifyBtn").addEventListener("click", function (){
        const frm = document.querySelector("#form");
        frm.method = "post";
        frm.action = "/event/blackFridayRegist";
        frm.submit();
    });
