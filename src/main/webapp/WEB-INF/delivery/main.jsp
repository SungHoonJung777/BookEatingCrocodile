        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> 배송 정보</h4>
                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach var="list" items="${orderList}">
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" class="order_idx" name="order_idx" id="order_idx" value="${list.order_idx}">
                                        <td>
                                        <select class="form-control" id="pro_category1" name="pro_category1">
                                            <option  disabled="disabled" selected="selected">${list.delivery}</option>
...
<script>
  /*  const moveForm = document.querySelector("#moveForm");
    ...
    function openPopup(orderStatus) {
        ...
        let popupUrl = "/admin/deleveryChoice?order_idx=" + order_idx; // 팝업 창에 표시할 내용에 대한 URL을 여기에 설정합니다.

        // 팝업 창 옵션 설정
        let popupOption = "width=900,height=400,scrollbars=yes,resizable=yes";

        // 팝업 창 열기
        window.open(popupUrl, orderStatus, popupOption);
    }*/
</script>
    <script>
        ...
        document.querySelectorAll(".form-control").forEach(function(select) {
            select.addEventListener("change", function() {
                ...
                let order_idx = this.closest("tr").querySelector(".order_idx").value;
