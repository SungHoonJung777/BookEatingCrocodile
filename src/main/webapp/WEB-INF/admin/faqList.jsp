        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <form action="/admin/faq/delete" method="get">
                                            ...
                                            <tr id="accordion${status.count}" class="accordion-collapse collapse"
                                                ...
                                                <td>
                                                        ...
                                                        <button type="submit" class="btn p-0  hide-arrow"
                                                                onclick="location.href='/admin/faq/modify?qna_idx=${dto.qna_idx}'"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                    ...
                                    <button type="button" class="btn btn-sm btn-primary" onclick="location.href='/admin/faq/write'">글 등록
                                    </button>
