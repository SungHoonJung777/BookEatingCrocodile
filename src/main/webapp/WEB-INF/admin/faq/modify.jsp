                        ...
                        <div class="col-xl">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select id="qna_select" name="qna_select" onchange="goList()" class="border-0 form-select-sm bg-light me-3">
                                            ...
                                            <option value="배송문의" <c:if test="${qnaDTO.qna_select eq '배송문의'}"> selected</c:if>>배송문의</option>
                                ...
                                <div class="card-body">
                                        ...
                                        <button type="reset" class="btn btn-secondary" onclick="location.href='/admin/faq/view'">게시글로 돌아가기</button>
                                        <button type="button" id="adminDelete" class="btn btn-primary" >삭제하기</button>
