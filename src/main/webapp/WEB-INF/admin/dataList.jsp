        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row">
                        <form action="/admin/data/delete" method="get">
                            <div class="col-md-12">
                                        ...
                                        <table class="table no-wrap">
                                            ...
                                            <c:forEach items="${dataList.dtoList}" var="dto" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap"><a href="/admin/data/view?comu_idx=${dto.comu_idx}">${dto.comu_title} <c:if test="${not empty dto.comu_file}"> <i class="fa-solid fa-paperclip"></i> </c:if></a></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" onclick="location.href='/admin/data/write'">글등록</button>
