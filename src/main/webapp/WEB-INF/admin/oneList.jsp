        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <form role="search" id="frmSearch">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-2">
                                ...
                                <button class="btn btn-outline-success" id="btnReset" type="reset" onclick="location.href='/admin/oneList'">reset</button>
                            </div>
                        </div>
                    </form>
                    <form id="frmSort">
                    ...
                    <div class="row">
                        <form action="/admin/one/delete" method="get">
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    <!-- Notifications -->
                                    <h5 class="card-header">1:1 문의글</h5>
                                    <div class="card-body">
                                        <br>
                                        <span>
                                            ...
                                            <c:forEach items="${qnaList.dtoList}" var="dto" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap"><a
                                                            href="/admin/one/view?qna_idx=${dto.qna_idx}">${dto.qna_title}</a>
                                                    </td>
                                                        ...
                                                        <td class="text-nowrap">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${fn:length(answer) > 10}">
                                                                    <a href="/admin/one/view?qna_idx=${dto.qna_idx}"><strong>${fn:substring(answer, 0, 10)}</strong></a>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <a href="/admin/one/view?qna_idx=${dto.qna_idx}"><strong>${dto.qna_answer}</strong></a>
                                                                </c:otherwise>
                                                            </c:choose>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <c:if test="${not empty sessionScope.member_id}">
                                        <button type="button" class="btn btn-sm btn-primary" onclick="location.href='/admin/one/write'">글등록</button>
                                    </c:if>
