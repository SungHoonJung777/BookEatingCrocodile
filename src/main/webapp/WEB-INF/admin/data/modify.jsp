                    ...
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/admin/data/modify" method="post" enctype="multipart/form-data">
                                        ...
                                        <button type="reset" class="btn btn-secondary" onclick="location.href='/admin/data/view?comu_idx=${dataDTO.comu_idx}'">게시글로 돌아가기</button>
