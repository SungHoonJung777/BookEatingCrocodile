                        ...
                        <form action="/admin/notice/delete" method="get">
                                        ...
                                        <table class="table no-wrap">
                                            ...
                                            <c:forEach items="${dataList.dtoList}" var="dto" varStatus="status">
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap"><a href="/admin/notice/view?comu_idx=${dto.comu_idx}">${dto.comu_title} <c:if test="${not empty dto.comu_file}"> <i class="fa-solid fa-paperclip"></i> </c:if></a></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" onclick="location.href='/admin/notice/write'">글등록</button>
