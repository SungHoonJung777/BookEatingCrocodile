                                ...
                                <div class="card-body">
                                    ...
                                    <c:if test="${dataDTO.member_id eq sessionScope.member_id}">
                                        <button type="submit" class="btn btn-primary"
                                                onclick="location.href='/admin/notice/modify?comu_idx=${dataDTO.comu_idx}'">수정하기
                                        </button>
                                    ...
                                    <button type="reset" class="btn btn-secondary" onclick="location.href='/admin/noticeList'">
                                        목록으로
                                    </button>
                                </div>
...
<script>
    ...
    function dataDelete(comu_idx) {
        ...
        if (yn) {
            location.href = "/admin/notice/delete?comu_idx=" + comu_idx;
        }
