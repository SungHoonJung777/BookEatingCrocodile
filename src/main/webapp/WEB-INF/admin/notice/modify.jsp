                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/admin/notice/modify" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="commu_category" value="${dataDTO.commu_category}">
                                        ...
                                        <button type="reset" class="btn btn-secondary" onclick="location.href='/admin/notice/view?comu_idx=${dataDTO.comu_idx}'">게시글로 돌아가기</button>
