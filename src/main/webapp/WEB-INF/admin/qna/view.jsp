                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="reset" class="btn btn-secondary" onclick="location.href='/admin/qnaList'">
                                        목록으로
                                    </button>
                                        ...
                                        <c:if test="${qnaDTO.qna_answer_YN eq 'N'}">
                                            ...
                                            <button type="button" class="btn btn-primary"
                                                    onclick="location.href='/admin/qna/adminWrite?qna_idx=${qnaDTO.qna_idx}'">
                                                답변달기
                                            </button>
                                        </c:if>
                                    </c:if>
...
<script>
    ...
    document.getElementById("adminDelete").addEventListener("click", () => {
        ...
        if (yn) {
            location.href = "/admin/qna/adminDelete?qna_idx=${qnaDTO.qna_idx}";
        }
    ...
    function qnaDelete(qna_idx) {
        ...
        if (yn) {
            location.href = "/admin/qna/delete?qna_idx=" + qna_idx;
        }
