                                    ...
                                    <table class="table no-wrap">
                                        ...
                                        <c:forEach items="${qnaList.dtoList}" var="dto" varStatus="status">
                                            ...
                                            <td class="text-nowrap">${qnaList.total_count - ((qnaList.page-1)*qnaList.page_size + (status.count-1))}</td>
                                                 <td class="text-nowrap"><a href="/admin/one/view?qna_idx=${dto.qna_idx}">${dto.qna_select}</a></td>
                                                        ...
                                                        <td class="text-nowrap">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="/admin/one/modify?qna_idx=${dto.qna_idx}"><i class="bx bx-edit-alt me-2"></i> Edit</a>
...
<script>
    function qnaDelete(qna_idx) {
        ...
        if (yn) {
            location.href="/admin/one/delete?qna_idx="+qna_idx;
        }
        location.href="#";
    }
