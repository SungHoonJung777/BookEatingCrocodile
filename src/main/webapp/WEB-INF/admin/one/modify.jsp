                    ...
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="/admin/one/modify" method="post">
                                        ...
                                        <button type="reset" class="btn btn-secondary" onclick="location.href='/admin/one/view?qna_idx=${qnaDTO.qna_idx}'">게시글로 돌아가기</button>
