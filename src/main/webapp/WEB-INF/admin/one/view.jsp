                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="submit" class="btn btn-primary" onclick="location.href='/admin/one/modify?qna_idx=${qnaDTO.qna_idx}'">수정하기</button>

                                    </c:if>
                                    <button type="reset" class="btn btn-secondary" onclick="location.href='/admin/oneList'">목록으로</button>
<%--                                   <c:if test="${sessionScope.loginInfo.member_id eq 'admin'} ">--%>
                                        <c:if test="${qnaDTO.qna_answer_YN eq 'Y'}">
                                            <button type="button" class="btn btn-primary" onclick="location.href='/admin/one/adminWrite?qna_idx=${qnaDTO.qna_idx}'">답변수정</button>
                                        </c:if>
                                        <c:if test="${qnaDTO.qna_answer_YN eq 'N'}">
                                        <button type="button" class="btn btn-primary" onclick="location.href='/admin/one/adminWrite?qna_idx=${qnaDTO.qna_idx}'">답변달기</button>
                                        </c:if>
<%--                                  </c:if>--%>
                                </div>
...
<script>
    ...
    document.getElementById("adminDelete").addEventListener("click", () => {
        ...
        if (yn) {
            location.href="/admin/one/adminDelete?qna_idx=${qnaDTO.qna_idx}";
        }
